...
class bittorrent_client():
    ...
    # initialize the BTP client with torrent file
    ...
    # connecting to the trackers mangaing a swarm of peers sharing same file
    ...
    # swarm initialization from the active tracker connection response peer data participating in file sharing
    ...
    # function helps in uploading the torrent file that client has downloaded completely
    # client becomes the seeder
    def seed(self):
    ...
    #  downloading the torrent file form swarm in which peers are sharing file data
    def download(self):
        # download file initialization 
